...
def grad_cam(input_model, image, category_index, layer_name, nb_classes=1000):
    model = Sequential()
    ...
    conv_output = [layer for layer in model.layers[0].layers if layer.name
                   is layer_name][0].output
